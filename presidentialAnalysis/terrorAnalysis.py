...
sys.stdout.flush()
attackCoCo, TF, docTF = sd.coOccurence(attackTokens,6)
...
sys.stdout.flush()
startTime=time.time()
attackDSM=sd.DSM(attackCoCo,50)
endTime=time.time()
print('finished DSM!')
...
sys.stdout.flush()
startTime=time.time()
attackCVDict=sd.contextVectors(attackTokens, attackDSM, attackWordList, 6)
...
sys.stdout.flush()
startTime=time.time()
preAttackCosine=sd.averageCosine(attackCVDict,preAttackFiles,attackWordList,1000)
endTime=time.time()
...
sys.stdout.flush()
startTime=time.time()
postAttackCosine=sd.averageCosine(attackCVDict,postAttackFiles,attackWordList,1000)
endTime=time.time()
...
preAttackTF=sd.getPeriodTF(docTF,preAttackFiles)
...
postAttackTF=sd.getPeriodTF(docTF,postAttackFiles)
...
sys.stdout.flush()
startTime=time.time()
preAttackKNN=sd.knnContextVector(attackCVDict,preAttackFiles,contextList,attackWordList,1000,5)
endTime=time.time()
...
sys.stdout.flush()
startTime=time.time()
postAttackKNN=sd.knnContextVector(attackCVDict,postAttackFiles,contextList,attackWordList,1000,5)
endTime=time.time()
